...
```
192.168.1.100 grafana.feanor.com.br
192.168.1.100 prometheus.feanor.com.br
192.168.1.100 alertmanager.feanor.com.br
```
...
| Serviço | URL | Login |
|---|---|---|
| Grafana | `http://grafana.feanor.com.br` | usuário `admin`, senha definida no `values.yaml` |
| Prometheus | `http://prometheus.feanor.com.br` | sem login |
| Alertmanager | `http://alertmanager.feanor.com.br` | sem login |
...
- **Uptime Kuma**: complementar com um monitor simples de "está no ar ou não" para cada URL (`nextcloud.feanor.com.br`, etc), mais leve e visual que o Alertmanager para esse tipo de checagem.
